...
//		}
		...
		if (!diretorio.exists()) {
			options.setOutputFileName("/tmp/" + Formatacao.completaComZerosAEsquerda(codctd,11) + "_" + cpfcnpj + "_01.pdf");
		} else {
			options.setOutputFileName("C:/pgmweb/" + Formatacao.completaComZerosAEsquerda(codctd,11) + "_" + cpfcnpj + "_01.pdf");
		}
//		if (modoTeste){
...
//		}
	...
	public static void gravaArquivoURL(String stringUrl, String codctd, String cpfcnpj, String tipoArq) {
		try {
	        ...
	        File diretorio = new File("C:\\pgmweb");
			if (!diretorio.exists()) {
				fileOut = new FileOutputStream("/tmp/" + Formatacao.completaComZerosAEsquerda(codctd,11) + "_" + cpfcnpj + "_" + tipoArq + ".pdf");
			} else {
				fileOut = new FileOutputStream("C:/pgmweb/" + Formatacao.completaComZerosAEsquerda(codctd,11) + "_" + cpfcnpj + "_" + tipoArq + ".pdf");
			}
